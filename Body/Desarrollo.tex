...
\subsection{Tareas por semana:}
\subsubsection{Tercera Semana de Febrero 2025}
\begin{itemize}
...
\subsubsection{Cuarta Semana de Febrero 2025}
\begin{itemize}
...
\subsubsection{Primera Semana de Marzo 2025}
\begin{itemize}
...
\begin{itemize}
	\item \textbf{Metodología ITIL} para gestión de incidentes y cambios
...
\begin{itemize}
	\item Limitación de recursos técnicos locales (75\% de equipos administrados remotamente desde Chihuahua)
	\item Obsolescencia tecnológica acelerada (40\% de equipos con más de 5 años de antigüedad)
